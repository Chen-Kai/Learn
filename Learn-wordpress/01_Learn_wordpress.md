...
Step3-1:如失敗自行新建一組 wp-config.php <br>
...
Step3-2:新建一組 wp-config.php <br>
步驟1:在命令提示字元touch wp-config.php<br>
步驟2:將所需的資料寫入至wp-config.php
